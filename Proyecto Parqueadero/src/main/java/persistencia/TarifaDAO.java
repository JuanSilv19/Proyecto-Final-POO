...
public class TarifaDAO implements I_CRUD<Tarifa> {
 ...
 public Tarifa leerPorTipo(String tipoVehiculo) throws SQLException {
  String sql = "SELECT id_tarifa, tipo_vehiculo, tarifa_hora, tarifa_dia FROM tarifas WHERE tipo_vehiculo = ?";
  Tarifa t = null;
  try (Connection c = conexionDB.conectar();
